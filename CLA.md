# About the University Corporation for Atmospheric Research (UCAR)/Unidata Contributor License Agreement

Everybody who contributes code to UCAR/Unidata is going to be asked to sign a
Contributor License Agreement (CLA). UCAR/Unidata’s CLA comes from
...
contribute the code/documentation to UCAR/Unidata and are willing to have it used in
...
therefore use UCAR/Unidata’s Rosetta, confident that they will not be asked to stop using pieces
of the code at a later date.

Lastly, the CLA gives  project permission to change the license under
...
license to UCAR/Unidata to distribute your code without further restrictions. This is
not the case for all CLA's, but it is the case for the one we are using.

## What about if I do Rosetta development as part of my job?

If any of your contributions to Rosetta are created as part of your employment by
...
into Rosetta. They will need to include the names of any developers (you and any
...
Rosetta patches as part of a job, make sure you and your employer understand who
...
Modified slightly to reflect the UCAR/Unidata project Rosetta.
...
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by electronic submission, following the instructions at https://www.clahub.com/agreements/Unidata/rosetta. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
