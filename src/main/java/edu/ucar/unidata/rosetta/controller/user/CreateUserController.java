...
public class CreateUserController implements HandlerExceptionResolver {
     ...
     *
     * @param createUserValidator  The validator used to validate User objects associated with this controller class.
     */
    @Autowired
     ...
     *
     * The view is the user view.  The model contains a blank User object and
     * action information which will be loaded and displayed in the view via jspf.
     *
     * Only users with a role of 'ROLE_ADMIN' are allowed to create new users
     * using this method (See register method for public access.)
     *
    ...
    public ModelAndView processUserCreation(@Valid User user, BindingResult result, Model model) throws RosettaUserException {
    ...
    public ModelAndView processRegistration(@Valid User user, BindingResult result, Model model) throws RosettaUserException {
