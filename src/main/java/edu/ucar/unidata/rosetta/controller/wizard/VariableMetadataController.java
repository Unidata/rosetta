...
public class VariableMetadataController {
    ...
    public ModelAndView displayVariableMetadataForm(Model model, RedirectAttributes redirectAttrs, HttpServletRequest request)
        ...
        model.addAttribute("customFileAttributesStep",
                wizardManager.customFileAttributesStep(rosettaCookie.getValue()));
        ...
        model.addAttribute("delimiterSymbol",
                resourceManager.getDelimiterSymbol(wizardData.getDelimiter()));
    ...
    public ModelAndView processVariableMetadata(WizardData wizardData, @RequestParam("submit") String submit, BindingResult result, RedirectAttributes redirectAttrs,
