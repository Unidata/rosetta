...
import edu.ucar.unidata.rosetta.service.user.validators.PasswordValidator;
...
public class ResetPasswordController implements HandlerExceptionResolver {
     ...
     *
     * @param passwordValidator  The validator used to validate User objects associated with this controller class.
     */
    @Autowired
     ...
     *
     * View is the user view.  The model contains:
     ...
     *
     * Only the User/owner and Users with a role of 'ROLE_ADMIN' are allowed to edit the User account.
     *
    ...
    public ModelAndView processUserPasswordReset(@PathVariable String userName, @Valid User user, BindingResult result, Model model) throws RosettaUserException {
     ...
     *
     * The view is the user view.  The model contains the User object with the password
     * to edit and the information which will be loaded and displayed in the view via jspf.
     *
     * Only the User/owner and Users with a role of 'ROLE_ADMIN' are allowed to edit the User's password.
     *
     * @param userName  The 'userName' as provided by @PathVariable.
     * @param model  The Model used by the View.
    ...
    public String resetUserPassword(@PathVariable String userName, Model model) throws RosettaUserException {
