...
public class ApplicationInitialization implements ServletContextListener {
    ...
    /**
     * Compares the configuration information in the user's application.properties file in ROSETTA_HOME
     * with the default configuration settings of this version of Rosetta to see if there are any new
     * configs to be added.  Missing configuration properties are noted in the logs and handed over to
     * another method to be written out to the user's application.properties file.
     * TODO: In future, notify admin of these differences via interface and let him/her sort it out.
     *
     * @param props The configuration properties as per the application.properties file in ROSETTA_HOME.
    ...
    /**
     * Writes the provided default properties to the application.properties configuration file
     * in ROSETTA_HOME to ensure user's copy is the most recent and contains any new additions
     * added in more recent versions of Rosetta.
     *
