...
/**
 * The DatabaseInitializationManager is responsible for creating and shutting down the
...
public interface DatabaseInitializationManager {
     ...
     *
     * The props argument contains information gleaned from the rosetta.properties file.
     * Developers can pass custom database information to this method via rosetta.properties,
     * such as:
     *
     *      1) database driver
     *      2) database name
     ...
     *      4) etc.
     *
     * @param props Properties from rosetta.properties that may be used to create the database.
