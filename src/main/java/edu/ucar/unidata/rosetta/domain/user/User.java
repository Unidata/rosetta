...
public class User implements UserDetails, Serializable {
     ...
     * Always true (credential expiration not currently supported.)
     *
     * @return true
     */
    @Override
     ...
     * (Account locking not supported at this time.)  See isEnabled().
     *
     * @return true
     */
    @Override
     ...
     * (Account expiration not supported at this time.)  See isEnabled().
     *
     * @return true
     */
    @Override
