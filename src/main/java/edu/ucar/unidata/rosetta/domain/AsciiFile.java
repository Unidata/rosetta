...
public class AsciiFile {
  ...
  /**
   * Returns "other info" associated with this file. Allows for modifications and additions to the
   * file object in the WizardController.
   *
  ...
  /**
   * Sets "other info" associated with this file. Allows for modifications and additions to the file
   * object in the WizardController.
   */
  ...
  /**
   * Returns the "stringified" json object that holds all of the sessionStorage information.
   *
  ...
  /**
   * Sets the "stringified" json object that holds all of the sessionStorage information.
   */
  ...
  /**
   * Returns the local (unique, alphanumeric) directory name where the uploaded ASCII file resides
   * on disk.
   *
  ...
  /**
   * Sets the local directory name where the ASCII file resides on disk. The local file directory is
   * a unique alphanumeric file name composed of the uploader's IP address and java.util.Date of
   * when the file was uploaded.  The uniqueId is created by the controller while writing the file
