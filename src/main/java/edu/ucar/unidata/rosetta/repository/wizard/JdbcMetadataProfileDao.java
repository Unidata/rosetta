...
public class JdbcMetadataProfileDao extends JdbcDaoSupport implements MetadataProfileDao {
  ...
  public String getComplianceLevelForAttribute(String attributeName, String profile) {
    ...
    List<MetadataProfile> metadataProfile =
        getJdbcTemplate().query(sql, new JdbcMetadataProfileDao.MetadataProfileMapper(), attributeName, profile);
  ...
  public List<MetadataProfile> getMetadataProfileByType(String metadataProfileType) {
    ...
    List<MetadataProfile> metadataProfile =
        getJdbcTemplate().query(sql, new JdbcMetadataProfileDao.MetadataProfileMapper(), metadataProfileType);
    if (metadataProfile.isEmpty()) {
