...
public class ZipFileUtil {
    ...
    /**
     * Cleans up the zip file inventory. (Some auto-generated OS files can really play havoc
    ...
    /**
     * Reads and returns that data from a file in a zip file in string format (used to get JSON file data).
     *
