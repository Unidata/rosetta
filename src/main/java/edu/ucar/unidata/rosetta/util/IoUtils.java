...
public class IoUtils {
   ...
   */
  public static String createUserFilesSubDirectory(String id) throws RosettaFileException {
    ...
    if (!localFileDir.exists()) {
      if (!localFileDir.mkdirs()) {
        throw new RosettaFileException("Unable to create " + id + " subdirectory in user_files directory.");
      }
    }
