...
public class VariableInfoUtils {
  ...
  private static List<String> timeVarTypes = Arrays.asList(relativeTime, timeOnly, dateOnly, fullDateTime);
  ...
  public static Optional<Double> findMissingValue(VariableInfo vi) {
    ...
    Optional<RosettaAttribute> missingValueRosettaAttr =
        Optional.ofNullable(VariableInfoUtils.findAttributeByName("missing_value", vi));
