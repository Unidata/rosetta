SELECT
  ...
  public.vw_get_profilestructureattributes.attributename AS "attributeName",
  ...
  trim(both public.vw_get_profilestructureattributes.fmt_structurename_short) AS "metadataTypeStructureName",
...
WHERE
  public.vw_get_profilestructureattributes.idprofile = 3 AND
  public.vw_get_profilestructureattributes."group" NOT IN ('CF','ACDD','root') AND
