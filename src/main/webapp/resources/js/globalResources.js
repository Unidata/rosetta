...
function getKnownRequiredMetadataList(variableType) {
    ...
    for (var i = 0; i < metadata.length; i++) {                          
        ...
        // grab the required metadata entries 
        ...
        // Grab the required metadata entries that correspond to the both coordinate or non-coordinate variables
...
function getKnownRecommendedMetadataList(variableType) {
    ...
    for (var i = 0; i < metadata.length; i++) {                          
        ...
        // Grab the metadata entries that correspond to the variable type (coordinate or non-coordinate), 
        // grab the recommended metadata entries 
        if (metadataItem.type == variableType) {
        ...
        // Grab the recommended metadata entries that correspond to the both coordinate or non-coordinate variables
        if (metadataItem.type == "both") {
            if (metadataItem.necessity == "recommended") {
                recommendedMetadata.push(metadataItem.entry);
            }
...
function getKnownAdditionalMetadataList(variableType) {
    ...
    for (var i = 0; i < metadata.length; i++) {                          
        ...
        // Grab the metadata entries that correspond to the variable type (coordinate or non-coordinate), 
        // grab the additional metadata entries 
        if (metadataItem.type == variableType) {
        ...
        // Grab the additional metadata entries that correspond to the both coordinate or non-coordinate variables
        if (metadataItem.type == "both") {
            if (metadataItem.necessity == "additional") {
                additionalMetadata.push(metadataItem.entry);
            }
