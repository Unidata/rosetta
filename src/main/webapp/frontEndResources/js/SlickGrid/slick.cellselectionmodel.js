(function ($) {
  ...
  function CellSelectionModel(options) {
    ...
    if (typeof options === "undefined" || typeof options.cellRangeSelector
        === "undefined") {
    ...
    function init(grid) {
      ...
      _selector.onBeforeCellRangeSelected.subscribe(
    ...
    function destroy() {
      ...
      _selector.onBeforeCellRangeSelected.unsubscribe(
          handleBeforeCellRangeSelected);
    ...
    function handleCellRangeSelected(e, args) {
      _grid.setActiveCell(args.range.fromRow, args.range.fromCell, false, false,
          true);
    ...
    function handleKeyDown(e) {
      ...
      if (active && e.shiftKey && !metaKey && !e.altKey &&
        ...
        var new_last = new Slick.Range(active.row, active.cell, active.row
            + dirRow * dRow, active.cell + dirCell * dCell);
