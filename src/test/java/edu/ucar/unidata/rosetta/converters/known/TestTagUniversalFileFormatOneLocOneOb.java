...
public class TestTagUniversalFileFormatOneLocOneOb {
  ...
  private static String etuffFile = String.join(File.separator, etuffFileTld, "eTUFF-tuna-590051-small.txt");
  private static String etuffFileNc = String.join(File.separator, etuffFileTld, "eTUFF-tuna-590051-small.nc");
